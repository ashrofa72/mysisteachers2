        ...
        <Container maxWidth="xl">
          <Toolbar disableGutters>
            ...
            <Box sx={{ flexGrow: 1, display: { xs: "flex", md: "none" } }}>
              ...
              >
                {user && (
                  <MenuItem key={0} onClick={(e) => router.push("/home")}>
                ...
                {user && (
                  <MenuItem key={4} onClick={(e) => router.push("/aboutus")}>
                    <Typography textAlign="center" fontWeight="bold">
                      حول
                    </Typography>
                  </MenuItem>
                ...
                {user && (
                  <MenuItem
                    key={1}
                    onClick={(e) => router.push("/profileregister")}
                  >
                    <Typography textAlign="center" fontWeight="bold">
                      تسجيل
                    </Typography>
            ...
            <Box sx={{ flexGrow: 0 }}>
              <span style={{marginLeft: "5px",color: "white",fontWeight: "bold"}}>{user ? auth.currentUser.displayName : "No user"}</span>
